...
import vueicon from '../../public/vueicon.png'
import javascripticon from '../../public/javascripticon.png'
import visualstudioicon from '../../public/visualstudioicon.png'
import Phone from '../../public/phone.png'
import Vuefashion from '../../public/vuelaptop.png'
import VuefashionPhone from '../../public/vuephone3.png'
...
export default function Projects2({ directionLeft }: Props) {
  return (
    <div>
    <motion.div 
      initial={{
    ...
    max-w-full justify-evenly mx-auto items-center md:top-[500px] lg:-top-20 -top-[380px] wide'>
        ...
        <span className='text-[#008080] font-bold'>VUE JS Commercial Application.</span> Full-Stack E-commerce fashion platform which makes use of Vue Router.
        This website features complete order and payment options, blog page, newsletter, as well as an Account creation portal with sign-in options.
        <span className='text-[#008080] spanner'> VUE JS, CSS3, Javascript</span>
        </p>
   ...
   <motion.div className='lg:-mt-[2000px] md:scale-90 md:-mt-[930px] lg:flex lg:-ml-[150px] cursor-pointer ind -ml-[45px] -mt-[2060px] lg:scale-75 scale-75 md:flex wide'>
   <div className='ml-[70px]'>
  <a href="https://github.com/Victoriaidunorba/2023commercial"  rel='noopener' target="_blank" className="button2">
...
<a href="https://chiefoflaygurss.vercel.app/" rel='noopener' target="_blank">
<div className='button2 lg:flex flex md:flex lg:ml-[60px] md:ml-[70px] md:mt-[20px] lg:mt-[5px] ml-[250px] mt-[50px]'>
  <h2 className='button2__text cursor-pointer'>LIVE MODE</h2>
  <div className='mt-5 '>
