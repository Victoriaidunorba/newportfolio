...
export default function About({}: Props) {
  return (
    ...
    viewport={{once: true}}
    className='md:mt-[100px] -mt-[200px] bg-[#1116] relative overflow-hidden lg:-mt-[400px] wide2'>
      <div>
   ...
   */}
    ...
    <p className='pro2 md:w-[910px] md:ml-[40px] lg:text-2xl w-[500px] md:text-4xl md:font-normal lg:ml-[1030px] lg:w-[650px] lg:-mt-[350px] font-light tracking-[5px] space-y-10 text-2xl md:-mt-[60px]'>
      ...
      Most would describe my designs as "pixel-perfect". I desire perfection!😁
      During my free time you'd probably catch me writing (mostly poetry), playing video games or watching Anime. I love Anime!
      Anything you want to tell me? <Link href="/Contacts" rel='noopener' target='_blank'><span className='text-[#008080]  flex cursor-pointer hover:text-cyan-500'>send me a message<Image src={messageicon} alt="" className='flex' /></span></Link>
    </p>
