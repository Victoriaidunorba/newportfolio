...
export default function Skill15({ directionRight }: Props) {
  return (
    ...
    <div className='group relative md:hidden lg:hidden flex cursor-pointer top-48'>
        ...
        src="https://www.nicepng.com/png/detail/380-3804499_firebase-logo-google-logo-firebase-firebase-png.png"
        // initial={{
      ...
      h-24 w-24 md:w-28 md:h-28 xl:w-32 xl:h-32 rounded-full z-0'>
        <div className='flex items-center justify-center h-full'>
          <p className='text-1xl font-bold bg-[#000] text-white opacity-100'>FIREBASE</p>
        </div>
      </div>
        <div className='w-full absolute top-[30%] bg-[#f7abba]/10 left-0 h-[250px] -skew-y-12' />
    </div>
